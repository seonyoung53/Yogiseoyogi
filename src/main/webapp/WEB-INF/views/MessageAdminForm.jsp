...
<script>
	...
	function Chat__drawMessages(message) {
		if(message.msender == "admin"){
			var html = "<div><img src='resources/img/Profile/${store.simg}' id='profileImg'><b>"+ message.msender + "</b></div><div>" + message.mcontents + "</div>";
...
<body onload="Chat__loadNewMessages();">
	<div id="message">
		...
		<span style="font-weight: 700; font-size: 20px;">&emsp;&emsp;1:1 문의</span>
	</div>
	<div class="List" style="padding-top: 60px; padding-bottom: 60px;">
		<div class="chat-list"></div>
	</div>
	<div class="chat">
		<form onsubmit="sendAdminMessage(this); return false;">
			<input type="text" name="mreceiver" id="mreceiver" value="admin" style="display:none;"><br>
			<c:choose>
				<c:when test="${sessionScope.loginId ne null}">
