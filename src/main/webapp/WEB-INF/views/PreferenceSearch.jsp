...
<body>
	...
	<img src="resources/img/category/오뭐먹1.jpg" class="searchimg">	
	<div class="searchform">
	<form action="preferencesearch" method="post" name="preferencesearch">
		<div class="search1">
		<h2>선호하는 음식을 선택해 주세요.</h2><br>
		<input type="text" name="mid" value="${sessionScope.loginId}" style="display: none;">
			<table class="searchTable">
				<tr class="taste1">
	             	<td><input type="radio" name="taste1" id="taste1" value="한식">한식</td>
	             	<td><input type="radio" name="taste1" id="taste1" value="중식">중식</td>
	             	<td><input type="radio" name="taste1" id="taste1" value="일식/돈까스">일식/돈까스</td>
	             	<td><input type="radio" name="taste1" id="taste1" value="치킨">치킨</td>
	            <tr>
	             	
	             	<td><input type="radio" name="taste1" id="taste1" value="피자">피자</td>
	             	<td><input type="radio" name="taste1" id="taste1" value="패스트푸드">패스트푸드</td>
	             	<td><input type="radio" name="taste1" id="taste1" value="야식">야식</td>
	             	<td><input type="radio" name="taste1" id="taste1" value="분식">분식</td>
	            </tr>
	            <tr>
	             	<td><input type="radio" name="taste1" id="taste1" value="족발/보쌈">족발/보쌈</td>
	             	<td><input type="radio" name="taste1" id="taste1" value="아시안양식">아시안양식</td>
		...
		<h2>선호하는 맛을 선택해 주세요.</h2>
			...
			<br>
		 	...
		 	<input type="submit" class="menubtn" value="메뉴추천">
		</form>
	</div>
