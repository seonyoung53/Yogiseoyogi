...
public class KakaoLoginApi {
	...
	private final static String K_CLIENT_ID = "314d218b0ab7a2e303d39b49cd452784"; 
	// 카카오 개발자 페이지에서  로그인 Redirect URI 에 설정한 값 
	private final static String K_REDIRECT_URI = "http://localhost:8085/yogiseo/yoyokakaoLoginOK";
